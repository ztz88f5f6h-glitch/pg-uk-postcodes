...
DATA         = postcode--1.3.0.sql postcode--1.3.1.sql postcode--1.3.2.sql \
                postcode--1.3.0--1.3.1.sql postcode--1.3.1--1.3.2.sql
REGRESS      = parser binary sort random quirks format match partial dps range
